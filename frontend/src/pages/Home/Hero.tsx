      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-[#FF6B35]">Early to Rise, </span>
            <span className="text-white">Eat Fresh</span>
            <span className="text-white"> & Healthy to </span>
            <span className="text-[#FF6B35]">Live.</span>
          </h1>
          ...
          <Button
            size="lg"
            className="bg-[#FF6B35] hover:bg-[#FF6B35]/90 text-white text-base md:text-lg px-8 md:px-12 py-6 md:py-7"
          >
            Order Now
          </Button>
        </div>
