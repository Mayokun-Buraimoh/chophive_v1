...
function Contact() {
  return (
    <div className="min-h-screen bg-[#1E1E1E]">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#FF6B35]/10 to-transparent py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-[#FF6B35] rounded-full mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 shadow-2xl">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-[#FF6B35]/20 rounded-lg flex items-center justify-center">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 shadow-2xl">
                ...
                <div className="flex items-center gap-4">
                  <a
                    href="#"
                    className="w-12 h-12 bg-gray-700 hover:bg-[#FF6B35] rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-colors"
