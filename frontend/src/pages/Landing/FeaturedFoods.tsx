          ...
          >
            {foods.map((food) => (
              <div key={food.id} className="flex-shrink-0 relative group">
                <div className="relative w-[240px] h-[400px] rounded-t-full rounded-b-full bg-[#121212] border-none shadow-xl hover:shadow-2xl hover:shadow-[#A32110]/30 transition-all duration-300 hover:scale-105">
