      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
            ...
            {foods.map((food) => (
              <div key={food.id} className="flex-shrink-0 relative">
                <div className="relative w-[240px] h-[400px] rounded-t-full rounded-b-full bg-[#121212] border-none shadow-xl">
                  ...
                  <button
                    className="absolute top-3 right-3 w-12 h-12 rounded-full bg-[#A32110] flex items-center justify-center shadow-lg hover:scale-105 transition"
                    title="View Details"
                  ...
                  <Button
                    size="icon"
                    className="absolute bottom-3 right-3 bg-[#A32110] hover:bg-[#A32110]/90 text-white rounded-full h-10 w-10 shadow-lg z-10"
                    onClick={() => {
                      addToCart(food, 1);
                    }}
                  >
          ...
          <button
            ...
            className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-[#A32110] hover:bg-[#A32110]/90 text-white rounded-full p-2 z-10"
