          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-gray-700 shadow-2xl text-center">
            ...
            <div className="bg-gray-900/50 rounded-lg p-6 mb-8 border border-gray-700">
              <div className="flex items-center justify-center mb-4">
                <Package className="w-6 h-6 text-[#FF6B35] mr-2" />
            ...
            {/* What's Next */}
            <div className="bg-gradient-to-br from-[#FF6B35]/10 to-transparent rounded-lg p-6 mb-8 border border-[#FF6B35]/20">
              <h2 className="text-xl font-bold text-white mb-4">
                What's Next?
              </h2>
              <div className="space-y-3 text-left">
                <div className="flex items-start">
                  <div className="w-6 h-6 bg-[#FF6B35] rounded-full flex items-center justify-center flex-shrink-0 mr-3 mt-0.5">
